package com.cloudcheflabs.dataroaster.minio;
...
public class MinIOHiveEnabled {
    ...
    public static void main(String[] args) throws Exception {
        ...
        sparkConf.set("spark.sql.hive.metastore.jars", "/home/pcp/dataroaster/examples/spark/src/main/resources/lib/standalone-metastore-1.21.2.3.1.4.0-315-hive3.jar");
