...
@CommandLine.Command(name = "delete",
        ...
        description = "Delete Private Registry.")
public class DeletePrivateRegistry implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        for(Map<String, Object> map : servicesList) {
            ...
            if(serviceType.equals(ServiceDef.ServiceTypeEnum.PRIVATE_REGISTRY.name())) {
