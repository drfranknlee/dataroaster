...
@CommandLine.Command(name = "delete",
        ...
        description = "Delete Distributed Tracing.")
public class DeleteDistributedTracing implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        for(Map<String, Object> map : servicesList) {
            ...
            if(serviceType.equals(ServiceDef.ServiceTypeEnum.DISTRIBUTED_TRACING.name())) {
        ...
        // delete.
        return CommandUtils.deleteDistributedTracing(configProps, serviceId);
    }
}
