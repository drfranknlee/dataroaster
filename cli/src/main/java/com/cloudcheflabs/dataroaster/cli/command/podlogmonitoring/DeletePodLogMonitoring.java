...
@CommandLine.Command(name = "delete",
        ...
        description = "Delete Pod Log Monitoring.")
public class DeletePodLogMonitoring implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        // delete.
        return CommandUtils.deletePodLogMonitoring(configProps, serviceId);
    }
}
