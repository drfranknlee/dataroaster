...
@CommandLine.Command(name = "delete",
        ...
        description = "Delete Metrics Monitoring.")
public class DeleteMetricsMonitoring implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        for(Map<String, Object> map : servicesList) {
            ...
            if(serviceType.equals(ServiceDef.ServiceTypeEnum.METRICS_MONITORING.name())) {
