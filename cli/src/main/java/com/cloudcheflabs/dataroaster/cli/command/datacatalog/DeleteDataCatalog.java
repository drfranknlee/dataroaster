...
@CommandLine.Command(name = "delete",
        ...
        description = "Delete Data Catalog.")
public class DeleteDataCatalog implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        for(Map<String, Object> map : servicesList) {
            ...
            if(serviceType.equals(ServiceDef.ServiceTypeEnum.DATA_CATALOG.name())) {
