package io.spongebob.util;

import com.cedarsoftware.util.io.JsonWriter;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.spongebob.domain.Kubeconfig;
import io.spongebob.encrypt.KeyEncryptorProcessExecutor;
...
public class PropertiesUtilsTestRun extends TestBase {
    ...
    public void readKubeconfig() throws Exception {
        ...
        String encryptionKey = KeyEncryptorProcessExecutor.doExec("/home/pcp/spongebob/encyptor/enc", encryptedKey, "false");
