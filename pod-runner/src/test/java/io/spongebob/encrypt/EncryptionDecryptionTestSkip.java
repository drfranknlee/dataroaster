package io.spongebob.encrypt;

import io.spongebob.test.TestBase;
import io.spongebob.util.EncryptionUtils;
import io.spongebob.util.FileUtils;
import io.spongebob.util.PropertiesUtils;
...
public class EncryptionDecryptionTestSkip extends TestBase {
    ...
    public void printSecrets() throws Exception {
        ...
        String encryptionKey = KeyEncryptorProcessExecutor.doExec("c:/project/spongebob/encyptor/enc.exe", encryptedKey, "false");
