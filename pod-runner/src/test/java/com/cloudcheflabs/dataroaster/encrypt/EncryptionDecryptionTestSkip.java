package com.cloudcheflabs.dataroaster.encrypt;

import com.cloudcheflabs.dataroaster.util.EncryptionUtils;
import com.cloudcheflabs.dataroaster.util.PropertiesUtils;
import com.cloudcheflabs.dataroaster.test.TestBase;
import com.cloudcheflabs.dataroaster.util.FileUtils;
...
public class EncryptionDecryptionTestSkip extends TestBase {
    ...
    public void printSecrets() throws Exception {
        ...
        String encryptionKey = KeyEncryptorProcessExecutor.doExec("c:/project/dataroaster/encyptor/enc.exe", encryptedKey, "false");
