...
public class PrometheusStackHandler {

    private static Logger LOG = LoggerFactory.getLogger(PrometheusStackHandler.class);

    private static String moveFiles(K8sServices k8sServices, Kubeconfig kubeconfig) {

        String serviceTypeName = "monitoring";
        String serviceName = "kubernetes-prometheus";
